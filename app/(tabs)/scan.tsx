  ...
  const getDetails = async () => {
    try {
      if (cameraRef.current) {
        ...
        const prompt =
          'This is an image of packed food. What is the name of this food? what category is it (bread or milk or cheese or chicken or meats or fruits or vegetables?) what is the average weight of it? what is the average price of this piece in AED dirhams? What is the expiry date of it (extract it from the image if visible) (format it as dd/mm/yyyy)? how many of them are in the picture? Strictly, return the answers as a JSON object. A typical response should be as follows:{name: “Lays Chips” ,category: “Snack”, weight: “45 g",price: “7”,expiryDate: "20/07/2024", numberOfUnits: “1”}';
        // const imageParts = [
