  ...
  const handleBarCodeScanned = async ({ type, data }) => {
    ...
    fetch(url)
      ...
      .then(async (data) => {
        ...
        // API returns the expiry date in a YYYY/MM/DD but we need it on the DD/MM/YYYY formate 
        const reconstructedDate: string[] = [newProductData.expiryDate.substring(8, 10), newProductData.expiryDate.substring(5, 7), newProductData.expiryDate.substring(0, 4)];// List of day, month, year
        newProductData.expiryDate = reconstructedDate.join("/");// Updating the expiry date to the reconstructed date 
