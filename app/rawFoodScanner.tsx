  ...
  const getDetails = async () => {
    try {
      if (cameraRef.current) {
        ...
        const prompt =
          `This is an image of raw food. What is the name of this food? what category is it (fruit or vegetable? what is the average weight of it? what is the average price of this piece in AED dirhams? on average, for how many days does it stay fresh from todays date ${new Date()} (format it as dd/mm/yyyy)? how many of them are in the picture? Strictly, return the answers as a JSON object. A typical response should be as follows:{name: "Potato",category: "Vegetables",weight: "200 g",price: "2.5",expiryDate: "20/07/2024", numberOfUnits: "2"}`;
        // const imageParts = [
